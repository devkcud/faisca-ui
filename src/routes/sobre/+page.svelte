...
<MainLayout>
  <section class="flex gap-8 max-md:flex-col">
    <div>
      <h2 class="mb-4 text-3xl font-bold text-quaternary sm:text-4xl">
        Conheça o projeto <span class="text-accent">Faísca Científica</span> e descubra um universo
        de
    ...
    <div class="mb-4 flex max-h-[400px] min-h-[400px] gap-3 max-md:hidden">
      <div class="flex-1 space-y-3 *:rounded-xl *:object-cover">
        <img src="/assets/apresentacao.jpg" alt="" class="h-[calc(100%-11rem)] w-full" />
        <img src="/assets/sala.jpg" alt="" class="h-44 w-full" />
      </div>
  ...
  <section class="my-8 flex gap-8 text-white bleed-bg bleed-primary-light">
    <img
      ...
      alt=""
      class="max-w-60 object-contain object-bottom max-md:hidden"
    />

    <div class="space-y-4 p-4">
      <h2 class="max-w-96 text-2xl sm:text-3xl">
        Explore nossa história,
        <br />
        <span class="font-bold">e descubra os elementos que moldam nossa essência</span>
      </h2>

      <p>
        Nascido no Instituto de Estudos da Linguagem (IEL) da Unicamp, em parceria com a Etec
        Antonio Furlan (Barueri) e Etec Prof. Armando José Farinazzo, o Faísca Científica é um
        projeto de extensão de autoria da Professora Doutora Amanda Balduino que almeja a difusão do
        diálogo formador e transformador entre a Universidade e o Ensino Básico. Assim, o
        desenvolvimento do pensamento científico, crítico e autônomo dos diferentes agentes Nascido
        no Instituto de Estudos da Linguagem (IEL) da Unicamp, em parceria com a Etec Antonio Furlan
        (Barueri) e Etec Prof. Armando José Farinazzo, o Faísca Científica é um projeto de extensão
        de autoria da Professora Doutora Amanda Balduino que almeja a difusão do diálogo formador e
        transformador entre a Universidade e o Ensino Básico. Assim, o desenvolvimento do pensamento
        científico, crítico e autônomo dos diferentes agentes.
      </p>
    </div>
  </section>
  ...
  <section class="flex items-center gap-4">
    <div>
      ...
      <p>
        ...
        dentro desse intuito, a difusão do diálogo formador, transformador e necessário entre a
        Universidade e o Ensino Básico.
      </p>

      <div class="mt-8 flex gap-4 max-sm:flex-col">
        <article class="flex flex-1 gap-2">
          ...
          <div>
            ...
            <p class="opacity-80">
              ...
              raciocínio, a formulação de hipóteses, a investigação e a solução de problemas.
            </p>
          </div>
        </article>
        ...
        <article class="flex flex-1 gap-2">
          ...
          <div>
            ...
            <p class="opacity-80">
              ...
              incluindo alunos e docentes da Unicamp e do ensino médio.
            </p>
          </div>
        </article>
      </div>
    ...
    <img src="/assets/alvo.png" alt="" class="size-72 max-md:hidden" />
  </section>
</MainLayout>
